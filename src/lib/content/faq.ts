        ...
        questions: [
          {
            id: "series-overview",
            q: "莱因有哪些主要产品系列，该如何选择？",
            a: "莱因提供五大产品系列。M/MS（模拟系列）——覆盖 0.01~5,000 slpm 的成熟 MFC 与 MFM，适用于一般工业工艺。MD（数字系列）——RS-485 通信，8 点线性化达 ±0.25% F.S. 精度，亚秒级响应，推荐用于 PLC/PC 集成。EX（防爆系列）——防爆型（Ex ec IIC T4 Gc，IP 65）MFC 与 MFM，适用于危险环境。LEPC（压力系列）——面向 0.1~6 barA 低压应用的电子式压力控制器，精度 ±0.5% F.S。DO400（特殊订货）——针对特殊应用的定制规格控制器。所有标准系列均提供 MFC 与 MFM 形式；LEPC 与 DO400 仅提供 MFC 形式。",
          },
          {
            id: "m-vs-ms",
            q: "M 系列与 MS 系列有何不同？",
