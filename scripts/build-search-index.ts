...
const STATIC_ENTRIES: Record<Locale, SearchEntry[]> = {
  ...
  en: [
    ...
    },
    {
      id: "cat-analogue",
      type: "category",
      title: "Analogue Mass Flow Controllers",
      model: "",
      signal: "analogue",
      url: "/products/analogue",
    ...
    },
    {
      id: "cat-digital",
      type: "category",
      title: "Digital Mass Flow Controllers",
      model: "",
      signal: "digital",
      url: "/products/digital",
    ...
    },
    {
      ...
      model: "",
      url: "/company#certifications",
      breadcrumb: "Company › Certifications",
    },
    {
      id: "page-contact",
      type: "page",
...
async function main() {
  ...
  for (const locale of LOCALES) {
    ...
    console.log(
      `  wrote public/search/index.${locale}.json (${entries.length} entries)`,
    );
  }
